    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-50">
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 w-full max-w-xs border border-blue-100">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h2 className="text-lg font-extrabold text-blue-700 tracking-tight">Login to SkillMatch</h2>
        </div>
        ...
        <input name="email" value={form.email} onChange={handleChange} placeholder="Email" required className="w-full border rounded px-2 py-1 mb-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" autoFocus />
        <input name="password" type="password" value={form.password} onChange={handleChange} placeholder="Password" required className="w-full border rounded px-2 py-1 mb-4 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
